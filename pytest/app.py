...
from pytest.pytest_stack import PytestStack
...
#REGION = app.node.try_get_context('regions') or os.environ.get('CDK_DEFAULT_REGIONs', 'unknown')


env = core.Environment(region=REGION, account=ACCOUNT)

PytestStack(app, "PytestStack", env=env
